          ...
          return MaterialApp(
              ...
              theme: _setting.brightness.value == Brightness.light
                  ? ThemeData(
                      ...
                      primaryColorLight: Colors
                          .white, // button text color constant dark and light theme
                      backgroundColor: Colors
                          .black, // dynamic black color text in light theme
                      dividerColor:
                          Color(0xFF8c98a8).withOpacity(0.1), // divider color
                      focusColor: Color(0xFF2abd03)
                          .withOpacity(1.0), // input focused border color
                      /*focusColor: Color(0xFF2abd03).withOpacity(1.0),*/ // input focused border color
                      /*primaryColorDark:  Color(0xFF2abd03),*/
                      primaryColorDark: Color(
                          0xFF2abd03), // main theme color light and dark theme
                      colorScheme: ColorScheme.fromSwatch().copyWith(
                          /*secondary: Color(0xFF000000).withOpacity(1.0),*/
                          secondary: Colors.black, // button color
                          primary: Colors
                              .white, //  text color constant dark and light theme (white color)
                  ...
                  : ThemeData(
                      ...
                      floatingActionButtonTheme: FloatingActionButtonThemeData(
                          elevation: 0,
                          foregroundColor: Theme.of(context).primaryColor),
                      iconTheme: IconThemeData(color: Color(0xFF9999aa)),
                      dividerColor:
                          Color(0xFF9999aa).withOpacity(0.1), // divider color
                      hintColor: Color(0xFFaeaeae),
                      /*focusColor: Color(0xFF00aa13).withOpacity(1),*/ // input focused border color
                      focusColor: Color(0xFF2abd03)
                          .withOpacity(1.0), // input focused border color
                      backgroundColor: Colors
                          .white, // dynamic white color text in dark theme
                      primaryColorDark: Color(
                          0xFF2abd03), // main theme color light and dark theme
                  ...
                  onPrimary: const Color(0xFFeeeeee),*/
                      ...
                      textTheme: TextTheme(
                        ...
                        headline2: TextStyle(
                            fontSize: 17.0,
                            fontWeight: FontWeight.w600,
                            color: Color(0xFF9999aa).withOpacity(1.0),
                            height: 1.4),
                        headline1: TextStyle(
                            fontSize: 16.0,
                            fontWeight: FontWeight.w600,
