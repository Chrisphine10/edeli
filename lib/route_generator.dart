...
import 'package:edeli/src/pages/all_provider.dart';
import 'package:edeli/src/pages/category_productss.dart';
import 'package:edeli/src/pages/chat_page.dart';
import 'package:edeli/src/pages/editprofile.dart';
import 'package:edeli/src/pages/force_update.dart';
import 'package:edeli/src/pages/h_category.dart';
import 'package:edeli/src/pages/h_thankyou.dart';
import 'package:edeli/src/pages/introscreen.dart';
import 'package:edeli/src/pages/location_detector.dart';
import 'package:edeli/src/pages/maph.dart';
import 'package:edeli/src/pages/mobile_login.dart';
import 'package:edeli/src/pages/mybookings.dart';
import 'package:edeli/src/pages/new_password.dart';
import 'package:edeli/src/pages/notification.dart';
import 'package:edeli/src/pages/order_details.dart';
import 'package:edeli/src/pages/otp_verification_email.dart';
import 'package:edeli/src/pages/privacy_policy.dart';
import 'package:edeli/src/pages/recharge.dart';
import 'package:edeli/src/pages/register.dart';
import 'package:edeli/src/pages/services_page.dart';
import 'package:edeli/src/pages/stores_favorite.dart';
import 'package:edeli/src/pages/subcategory.dart';
import 'package:edeli/src/pages/timedatepage.dart';
import 'package:edeli/src/pages/topup.dart';

import 'package:edeli/src/pages/wallet.dart';
import 'package:edeli/src/pages/wallet_thankyou.dart';
import 'package:edeli/src/pages/wallet_transcation_history.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/ProductList':
        return MaterialPageRoute(
            builder: (_) => ProductList(pageType: args.toString()));
      case '/MainPage':
      ...
      case '/CategoryProduct':
        return MaterialPageRoute(
            builder: (_) => CategoryProduct(categoryData: args));
