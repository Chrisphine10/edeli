...
import 'package:edeli/src/models/bookingmodel.dart';
...
ValueNotifier<BookingModel> currentBookDetail =
    new ValueNotifier(BookingModel());
...
Future<bool> bookOrderData(int i) async {
  final String url =
      '${GlobalConfiguration().getValue('base_url')}api/HBook/do_add';
