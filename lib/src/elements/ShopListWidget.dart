...
import 'package:edeli/src/pages/grocerystore.dart';
import 'package:edeli/src/pages/store_detail.dart';
          ...
          child: InkWell(
            onTap: () {
              if (choice.openStatus) {
                ...
                Toast.show(
                  S.of(context).sorry_this_shop_currently_closed,
                  context,
                                  ...
                                  child: Container(
                                      ...
                                      child: Center(
                                        child: Container(
                                          ...
                                          child: Text(S.of(context).closed_now,
                                ...
                                children: [
                                  ...
                                  Wrap(children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(left: 3),
                                      child: Text(
                                          '     ${Helper.calculateTime(double.parse(choice.distance.replaceAll(',', '')), int.parse(choice.handoverTime), false)}',
                                          style: Theme.of(context)
                                              .textTheme
                                              .bodyText2),
                                    ),
                                  ...
                                  !Helper.shopOpenStatus(choice)
                                      ? Container(
                                          child: Text(
                                              'Open at ${choice.openingTime}  to ${choice.closingTime}',
                                              style: Theme.of(context)
                                                  .textTheme
                                                  .bodyText2
                                                  .merge(TextStyle(
