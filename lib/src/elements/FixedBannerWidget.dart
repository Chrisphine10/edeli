...
import 'package:edeli/src/models/slide.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      return index == 0
          ? InkWell(
              onTap: () {
                if (slider.superCategoryId != '2' &&
                    slider.superCategoryId != '7') {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => StoresGeneral(
                            superId: slider.superCategoryId,
                            pageTitle: slider.slider_text,
                            coverImage: slider.image,
                            offer: slider.para,
                            offerType: slider.redirect_type,
                            shopTypeId: slider.shopTypeId,
                          )));
