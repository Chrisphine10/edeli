...
import 'package:edeli/src/pages/product_list.dart';
import 'package:edeli/src/pages/stores_general.dart';
import 'package:edeli/src/pages/subcategory.dart';
import 'package:edeli/src/repository/hservice_repository.dart';
import 'package:edeli/src/repository/product_repository.dart';
...
class MiddleSliderWidget extends StatefulWidget {
  ...
  MiddleSliderWidget(
      {Key key, this.slides, this.pageType, this.para1, this.shopId})
      : super(key: key);
}
                  ...
                  return Container(
                    ...
                    child: Container(
                        ...
                        margin: EdgeInsets.only(
                            left: 5, right: 5, top: 10.0, bottom: 10),
                        child: ClipRRect(
                                      ...
                                      Navigator.of(context)
                                          .push(MaterialPageRoute(
                                              builder: (context) => ProductList(
                                                    pageType: 'offer',
                                                    subcategory_Id: _slideData
                                                        .superCategoryId,
                                                    offer: _slideData.para,
                                                    shopId: widget.shopId,
                                                  )));
                                    } else {
                                      if (_slideData.superCategoryId != '2' &&
                                          _slideData.superCategoryId != '7') {
                                            ...
                                            MaterialPageRoute(
                                                builder: (context) =>
                                                    StoresGeneral(
                                                      superId: _slideData
                                                          .superCategoryId,
                                                      pageTitle: _slideData
                                                          .slider_text,
                                                      coverImage:
                                                          _slideData.image,
                                                      offer: _slideData.para,
                                                      offerType: _slideData
                                                          .redirect_type,
                                                      shopTypeId:
                                                          _slideData.shopTypeId,
                                                    )));
                                      } else if (_slideData.superCategoryId ==
                                          '7') {
                                        currentBookDetail.value.categoryName =
                                            _slideData.slider_text;
                                        Navigator.of(context).push(
                                            MaterialPageRoute(
                                                builder: (context) =>
                                                    SubCategory(
