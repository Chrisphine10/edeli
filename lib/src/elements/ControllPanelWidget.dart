...
import 'package:edeli/src/controllers/home_controller.dart';
import 'package:edeli/src/models/explore_search.dart';
import 'package:edeli/src/models/shop_type.dart';
import 'package:edeli/src/pages/send_package.dart';
import 'package:edeli/src/pages/stores.dart';
          ...
          child:
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text(S.of(context).your_favorites,
            ...
            Container(
              ...
              child: Wrap(
                children:
                    List.generate(currentRecommendation.value.length, (index) {
                  ShopType _shopTypeData =
                      currentRecommendation.value.elementAt(index);
                        ...
                        child: Column(children: [
                          GestureDetector(
                            onTap: () {
                              ...
                              currentRecommendation.value.removeWhere(
                                  (item) => item.id == _shopTypeData.id);
                              ...
                              shopTypeData.coverImage =
                                  _shopTypeData.coverImage;
                              shopTypeData.previewImage =
                                  _shopTypeData.previewImage;
                              shopTypeData.title = _shopTypeData.title;
                              shopTypeData.homeShopType =
                                  _shopTypeData.homeShopType;

                              currentRecommendation.value
                                  .insert(0, shopTypeData);
                              ...
                              if (_shopTypeData.shopType == '7') {
                                ...
                                Navigator.push(context, MaterialPageRoute(
                                  ...
                                  return Stores(
                                    storeType:
                                        int.parse(_shopTypeData.homeShopType),
                        ...
                        child: Container(
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  CategoryShopType(
                                    shopType: _exploreData.focusType,
                                  )
                                ])),
                      );
                    },
