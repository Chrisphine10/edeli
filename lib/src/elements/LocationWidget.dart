          ...
          if (value == 1) {
            setState(() {
              currentUser.value.address
                  .removeWhere((item) => item.addressSelect == address);
            });
      ...
      Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Container(
              ...
              child: Text(S.of(context).select_delivery_address,
              ...
              ? ListView.builder(
                  ...
                  itemBuilder: (context, int index) {
                    Address _addressData =
                        currentUser.value.address.elementAt(index);
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(S.of(context).location_details,
                    ...
                    Container(
                        ...
                        child: TextFormField(
                            ...
                            autocorrect: true,
                            onSaved: (input) =>
                                widget.con.addressData.username = input,
                    ...
                    Container(
                        ...
                        child: TextFormField(
                            ...
                            keyboardType: TextInputType.text,
                            onSaved: (input) =>
                                widget.con.addressData.addressSelect = input,
                            validator: (input) => input.length < 3
                                ? S.of(context).should_be_more_than_3_characters
                                : null,
                            ...
                            decoration: InputDecoration(
                              labelText:
                                  'Shop / office / home location address with Door/Flat No',
                              labelStyle: Theme.of(context)
                                  .textTheme
                                  .bodyText2
                                  .merge(TextStyle(color: Colors.grey)),
                    ...
                    Container(
                        ...
                        child: TextFormField(
                            ...
                            keyboardType: TextInputType.text,
                            onSaved: (input) =>
                                widget.con.addressData.phone = input,
