...
// ignore: non_constant_identifier_names
  void ProductDescriptionBottomSheet(variantModel variant,
      ProductDetails2 productDetails, ProductController con) {
                                                                      ...
                                                                      Wrap(
                                                                          children: [
                                                                            Container(
                                                                                ...
                                                                                decoration: BoxDecoration(
                                                                                  color: Colors.white,
                                                                                  border: Border.all(width: 1, color: variant.foodType == 'Veg' ? Colors.green : Colors.brown),
                                                                                ),
                                                                                child: Icon(Icons.circle, size: 14, color: variant.foodType == 'Veg' ? Colors.green : Colors.brown)),
                                                                            currentVendor.value.bestSeller
                                                                                ? Container(padding: EdgeInsets.only(left: 5, top: 3), child: Icon(Icons.star, size: 19, color: Colors.orange))
                                                                                : Container(),
                                                                            currentVendor.value.bestSeller
                                                                                ? Container(
                                                                        ...
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              Text(productDetails.product_name, overflow: TextOverflow.ellipsis, maxLines: 2, style: Theme.of(context).textTheme.subtitle1),
                                                                              Container(
                                                                                  padding: EdgeInsets.only(right: 13),
                                                                                  child: Text(
                                                                                    Helper.pricePrint(variant.sale_price),
            ...
            return Stack(
              children: [
                _variantData.selected
                    ? Row(children: [
                        InkWell(
                          onTap: () {
                            ...
                            ProductDescriptionBottomSheet(
                                _variantData, widget.choice, widget.con);
                          },
                          child: ColorFiltered(
                            colorFilter: ColorFilter.mode(
                              Helper.itemAvailableStatus(widget.choice)
                                  ? Colors.black.withOpacity(0)
                                  : Colors.black.withOpacity(
                                      0.91), // 0 = Colored, 1 = Black & White
                                      ...
                                      children: [
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                padding: const EdgeInsets.only(
                                                    left: 8, top: 4),
                                                child: _variantData.discount !=
                                                            '' &&
                                                        _variantData.discount !=
                                                            '0'
                                                    ? Text(
                                                        Helper.pricePrint(
                                                            _variantData
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            if (Helper.shopOpenStatus(
                                                    currentVendor.value) ==
                                                true) ...[
                                              if (Helper.itemAvailableStatus(
                                                  widget.choice)) ...[
                                                1 ==
                                                        widget.con
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      child: Column(children: [
                                                        ...
                                                        Text(
                                                          '${widget.choice.fromTime} to ${widget.choice.toTime}',
                                                          style: Theme.of(
                                                                  context)
                                                              .textTheme
                                                              .caption
                    ...
                    : Container(),
                _variantData.discount != '' && _variantData.discount != '0'
                    ? Positioned(
                        top: 0,
                        left: 15,
                        child: Stack(clipBehavior: Clip.none, children: [
                          Container(
                              ...
                              child: Image(
                                  image:
                                      AssetImage('assets/img/toplable.png'))),
                          Align(
              ...
              child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Helper.shopOpenStatus(currentVendor.value) &&
                              Helper.itemAvailableStatus(widget.choice)
                          ? Align(
                              alignment: Alignment.bottomCenter,
                              child: Padding(
