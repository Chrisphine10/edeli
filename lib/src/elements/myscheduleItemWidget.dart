...
class MyscheduleItemWidget extends StatefulWidget {
  ...
  MyscheduleItemWidget({Key key, this.expanded, this.subscription, this.con})
      : super(key: key);
                ...
                child: Theme(
                  ...
                  child: ExpansionTile(
                    ...
                    trailing: Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: <Widget>[
                        Text(Helper.pricePrint(widget.subscription.grand_total),
                      ...
                      Column(
                        ...
                        (indexProduct) {
                          CartResponce productDetails =
                              widget.subscription.cart.elementAt(indexProduct);
                          return OrderItemProductWidget(
