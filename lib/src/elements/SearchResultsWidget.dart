...
import 'package:edeli/src/pages/search_item.dart';
...
class SearchResultWidget extends StatefulWidget {
  ...
  SearchResultWidget({Key key,  this.pageType, this.parentScaffoldKey}) : super(key: key);

  @override
  _SearchResultWidgetState createState() => _SearchResultWidgetState();
}

class _SearchResultWidgetState extends StateMVC<SearchResultWidget> with SingleTickerProviderStateMixin {

  HomeController _con;
  _SearchResultWidgetState() : super(HomeController()) {
    _con = controller;
  }
                                          ...
                                          _speech.listen(
                                            onResult: (val) => setState(() {
                                              ...
                                              if (val.hasConfidenceRating && val.confidence > 0) {
                                                ...
                                                _speech.stop();
                                                _con.listenForVendorItemSearch( _text);
