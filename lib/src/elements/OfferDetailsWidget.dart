...
import 'package:edeli/src/controllers/cart_controller.dart';
import 'package:edeli/src/elements/TermsPopupWidget.dart';
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                              ...
                                              child:Row(
                                                  children:[
                                                    _coupon.couponType!='4'?Text('${_coupon.discount.toInt()}',style:TextStyle(fontSize:30)):Text(''),
                                                    SizedBox(width:2),
