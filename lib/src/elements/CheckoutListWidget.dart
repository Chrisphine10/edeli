import 'package:edeli/src/models/coupon.dart';
                ...
                child: Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      SizedBox(width: 10),
                      Text(S.of(context).apply_coupons,
                ...
                child: Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      SizedBox(width: 10),
                      Text(
                          'Code ${currentCheckout.value.couponCode} is applied!',
                          style: Theme.of(context).textTheme.bodyText1),
                      Spacer(),
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        Text(S.of(context).item_total,
                            style: Theme.of(context).textTheme.subtitle2),
                        Text(Helper.pricePrint(currentCheckout.value.sub_total),
                            style: Theme.of(context).textTheme.subtitle2),
                      ],
                    ),
                    SizedBox(height: 10),
                            ...
                            children: <Widget>[
                              currentCheckout.value.deliverType != 3
                                  ? Row(
                                      ...
                                      children: <Widget>[
                                        Text(
                                            '${S.of(context).delivery_fee} ${Helper.priceDistance(currentCheckout.value.km)}',
                                            style:
                                      ...
                                      children: <Widget>[
                                        Text(S.of(context).delivery_tip,
                                            style: Theme.of(context)
                                                ...
                                                .subtitle2),
                                        Text(
                                            Helper.pricePrint(currentCheckout
                                                .value.delivery_tips),
                                            style: Theme.of(context)
                                                .textTheme
                                                .subtitle2),
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Expanded(
                                                ...
                                                child: Text(
                                                  '${S.of(context).taxes} & ${S.of(context).charges}',
                                                  overflow:
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.of(context)
                            .pushNamed('/policy', arguments: 'Return Policy');
                      },
                      child: Container(
