...
import 'package:edeli/src/controllers/product_controller.dart';
import 'package:edeli/src/helpers/helper.dart';
import 'package:edeli/src/models/product_details2.dart';
import 'package:edeli/src/models/variant.dart';
        ...
        : Container(
            ...
            child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ProductDetails2 _productDetails =
                      widget.productList.elementAt(index);
                    ...
                    Container(
                        ...
                        child: Column(
                            children: List<Widget>.generate(
                                _productDetails.variant.length, (index) {
                          variantModel _variantData =
                              _productDetails.variant.elementAt(index);
                                                      ...
                                                      child: Row(
                                                          ...
                                                          children: [
                                                            ...
                                                            if (Helper.shopOpenStatus(
                                                                ...
                                                                true) ...[
                                                              1 ==
                                                                      _con.checkProductIdCartVariant(
                                                                          _productDetails
                                                                              .id,
                                                                          _variantData
                                                                              .variant_id)
                                                                        ...
                                                                        child: Container(
                                                                            ...
                                                                            child: Row(
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Text(S.of(context).add, style: Theme.of(context).textTheme.subtitle2.merge(TextStyle(color: Theme.of(context).primaryColorLight, fontWeight: FontWeight.w600))),
                                                                              ],
                                                                            )),
                                                                      ),
                                                                    )
                                                                        ...
                                                                        child: Wrap(
                                                                            ...
                                                                            children: [
                                                                              InkWell(
                                                                                onTap: () {
                                                                                  setState(() {
                                                                                    _con.decrementQtyVariant(_productDetails.id, _variantData.variant_id);
                                                                                  });
                                                                                },
