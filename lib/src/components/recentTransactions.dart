            ...
            child: Row(
              ...
              children: [
                widget.PageType == 'full'
                    ...
                    : Text(''),
                widget.PageType == 'full'
                    ? Text(S.of(context).transaction_history,
            ...
            child: _con.walletTransactionList.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      WalletTransactions _walletData =
                          _con.walletTransactionList.elementAt(index);
                      return TransactionCard(
                        transactionId: _walletData.transactions_id,
                        date: _walletData.date,
                        color: _walletData.type == 'credit'
                            ? Colors.green
                            : Colors.red,
                        letter: _walletData.type == 'credit' ? 'C' : 'D',
                        title: _walletData.type == 'credit'
                            ? S.of(context).credit
                            : S.of(context).debited,
                        subTitle: _walletData.type == 'credit'
                            ? S.of(context).your_amount_is_credited
                            : S.of(context).your_amount_is_debited,
