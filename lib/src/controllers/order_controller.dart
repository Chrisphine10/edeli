...
import 'package:edeli/src/models/cancelled.dart';
import 'package:edeli/src/models/order_details.dart';
import 'package:edeli/src/models/shop_rating.dart';
...
class OrderController extends ControllerMVC {
  ...
  submitShopRating(
    ...
    if (shopRatingData.rate != null) {
      ...
      showToast("Please give your rating",
          gravity: Toast.BOTTOM, duration: Toast.LENGTH_SHORT);
    }
  }
  ...
  void cancelOrder() async {
    ...
    repository.cancelledOrder(cancelledData).then((value) {
      showToast("Your cancelled reason is update successfully",
          gravity: Toast.BOTTOM, duration: Toast.LENGTH_SHORT);
  ...
  updateHandyStatus(id, status) {
    FirebaseFirestore.instance
        ...
        .doc(id)
        .update({'paymentStatus': status}).catchError((e) {
      print(e);
    });
  ...
  updateOrderStatus(id, status) {
    FirebaseFirestore.instance
        ...
        .doc(id)
        .update({'grandState': status}).catchError((e) {
      print(e);
    });
  }
