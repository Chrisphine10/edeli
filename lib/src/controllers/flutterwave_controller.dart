...
import 'package:edeli/src/models/checkout.dart';
...
class FlutterWaveController extends ControllerMVC {
  ...
  void initState() {
    ...
    url = '${GlobalConfiguration().getString('api_base_url')}Flutterwave/index/${userRepo.currentUser.value.id}/${currentCheckout.value.grand_total}?$_apiToken';
