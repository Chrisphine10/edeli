...
import 'package:edeli/src/models/servicemodel.dart';
import 'package:edeli/src/models/userreview.dart';
...
class ServicesPage extends StatefulWidget {
  ...
  ServicesPage({Key key, this.parentScaffoldKey, this.providerData})
      : super(key: key);
              ...
              Stack(children: [
                      ...
                      Container(
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image:
                                      NetworkImage(widget.providerData.image),
                                  fit: BoxFit.cover)),
                          height: 158.0,
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 5.0),
                                Text(
                                  currentBookDetail.value.userRatingStatus,
                                  overflow: TextOverflow.ellipsis,
                                  maxLines: 1,
                                  textAlign: TextAlign.left,
                ...
                Positioned(
                  ...
                  right: size.width > 769
                      ? size.width * 0.1
                      : (MediaQuery.of(context).size.width / 2) - 175.0,
                  child: new Container(
                    width: 50.0,
                    height: 50.0,
                    child: Card(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        currentBookDetail.value.service =
                            widget.choice.services_name;
                        currentBookDetail.value.chargeperhrs =
                            widget.choice.amount;
