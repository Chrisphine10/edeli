import 'package:edeli/src/pages/flutterwave_payment.dart';
import 'package:edeli/src/pages/paypal_payment.dart';
import 'package:edeli/src/pages/stripe_payment.dart';
import 'package:edeli/src/pages/uip_india.dart';
                                      ...
                                      Expanded(
                                        child: Container(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                  '${S.of(context).wallet}   (${S.of(context).balance} ${Helper.pricePrint(currentUser.value.walletAmount)}) ',
                                                  style: Theme.of(context)
                                                      .textTheme
                                                      .headline1),
                                            ],
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            currentCheckout.value.shopTypeID == 2
                                ? Row(
                                    mainAxisAlignment:
                                    ...
                                    children: [
                                      Text('Packaging charges',
                                          style: Theme.of(context)
                                              ...
                                              .subtitle2),
                                      Text(
                                          '${Helper.pricePrint(currentCheckout.value.packingCharge)}',
                                          style: Theme.of(context)
                                              .textTheme
                                              .subtitle2)
                                    ],
                              ...
                              children: [
                                Text(S.of(context).delivery_tip,
                                    style:
                                        Theme.of(context).textTheme.subtitle2),
                                Text(
                                    '${Helper.pricePrint(currentCheckout.value.delivery_tips)}',
                                    style:
                                        Theme.of(context).textTheme.subtitle2)
                              ],
                            ),
                  ...
                  child: Container(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          if (currentCheckout.value.payment.method == '' ||
                              currentCheckout.value.payment.method == null) {
                            // ignore: deprecated_member_use
                            ...
                            if (currentCheckout.value.payment.method ==
                                'online') {
                              if (currentCheckout.value.payment.paymentType ==
                                  'RayzorPay') {
                                openCheckout();
