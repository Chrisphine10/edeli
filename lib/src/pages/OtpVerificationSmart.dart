...
class _OtpVerificationSmartState extends StateMVC<OtpVerificationSmart>
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                "${S.of(context).we_have_sent_the_code_verification_to_your_mobile_number} ${widget.mobileNo}",
                  ...
                  onPressed: () {
                    ...
                    PhoneAuthCredential phoneAuthCredential =
                        PhoneAuthProvider.credential(
                            ...
                            smsCode: _controllerOTPPhone.text);
