              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Image(
                      image: AssetImage('assets/img/package.png'),
                      width: 50,
                      height: 60,
                    ),
                  ),
                  Container(
                    ...
                    child: GestureDetector(
                      onTap: () {},
                      child: Text('Select Package Content',
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: ListView(
                          children:
                              List.generate(_con.ListData.length, (index) {
                        DropDownModel _dropData =
                            _con.ListData.elementAt(index);
                        return SelectPackage(
                          con: _con,
                          itemDetails: _dropData,
                        );
                      })),
                    ),
                  ),
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: [
                              ...
                              children: [
                                Container(
                                    ...
                                    child: TextFormField(
                                        ...
                                        autocorrect: true,
                                        controller:
                                            _con.deliveryAddressController,
                                        onTap: () async {
                                          /*Navigator.of(context).pushNamed('/Login');*/
                                          /** LocationResult result = await showLocationPicker(
                                                context,
                    ...
                    Padding(
                      padding: EdgeInsets.only(
                          top: 10, bottom: 50, left: 10, right: 25),
                      child: Row(
                        children: [
                          Padding(
                            padding:
                                EdgeInsets.only(top: 30, right: 10, left: 5),
                            child: Container(
                          ...
                          Expanded(
                            child: Container(
                                ...
                                child: TextFormField(
                                    ...
                                    autocorrect: true,
                                    onSaved: (input) =>
                                        _con.sendPackageData.message = input,
                                    keyboardType: TextInputType.text,
                                    style:
                    ...
                    InkWell(
                        ...
                        child: Container(
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Toast.show('Demo version', context,
                  ...
                  Wrap(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(widget.itemDetails.name,
