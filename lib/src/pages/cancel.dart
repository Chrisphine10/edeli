...
class CancelPage extends StatefulWidget {
  ...
  String shopId;
  CancelPage(
      {Key key, this.paymentData, this.shopName, this.orderId, this.shopId})
      : super(key: key);
  @override
              ...
              child: Column(
                ...
                children: [
                  Container(
                      ...
                      child: Text(
                        '${S.of(context).hi_there_im} ${setting.value.appName} bot.${S.of(context).i_have_cancelled_your_order_as_per_request_we_have_not_charged_you_any_cancellation} ',
                    ...
                    child: Column(children: [
                      Container(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 5),
                              Text(
                                  '${S.of(context).items}, ${Helper.pricePrint(widget.paymentData.grand_total)} | ${widget.paymentData.method}',
                                  style: TextStyle(
                      ...
                      Container(
                        ...
                        child: Row(children: [
                          ...
                          Container(
                            padding: EdgeInsets.only(left: 10),
                            child: Text('${Helper.pricePrint(0.0)}'),
                          ),
                        ]),
                      ),
                      Container(
                        ...
                        child: Row(children: [
                          ...
                          Container(
                            padding: EdgeInsets.only(left: 10),
                            child: widget.paymentData.method ==
                                    'cash on delivery'
                                ? Text('${Helper.pricePrint(0.0)}')
                                : Text(
                                    '${Helper.pricePrint(widget.paymentData.grand_total)}'),
                          ),
                        ]),
                            ...
                            child: Container(
                                ...
                                child: ListTile(
                                  ...
                                  title: Text(
                                    S
                                        .of(context)
                                        .i_choose_a_wrong_delivery_address,
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodyText2
                            ...
                            child: Container(
                                ...
                                child: ListTile(
                                  contentPadding: EdgeInsets.only(
                                      left: 0, right: 0, top: 0),
                                  title: Text(
                                    S.of(context).i_ordered_the_wrong_items,
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodyText2
                                        .merge(TextStyle(color: Colors.blue)),
                            ...
                            child: Container(
                                ...
                                child: ListTile(
                                  contentPadding: EdgeInsets.only(
                                      left: 0, right: 0, top: 0),
                                  title: Text(
                                    S.of(context).i_forgot_to_apply_coupon,
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodyText2
                                        .merge(TextStyle(color: Colors.blue)),
                            ...
                            child: Container(
                                ...
                                child: ListTile(
                                  contentPadding: EdgeInsets.only(
                                      left: 0, right: 0, top: 0),
                                  title: Text(
                                    S.of(context).i_changed_my_mind,
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodyText2
                                        .merge(TextStyle(color: Colors.blue)),
