...
import 'package:edeli/src/models/payment.dart';
      ...
      snapshot.docs.forEach((result) {
        ...
        if (result.data()["status"] == 'Completed') {
          ...
          BitmapDescriptor.fromAssetImage(ImageConfiguration(size: Size(5, 5)),
            ...
            LatLng _driver = LatLng(result.data()["driverLatitude"],
                    ...
                    return snapshot.data.docs[0]['status'] == 'Placed' &&
                                ...
                                Padding(
                                  ...
                                  child: CircleAvatar(
                                    ...
                                    backgroundImage: NetworkImage(
                                        "${GlobalConfiguration().getString('base_upload')}/uploads/vendor_image/vendor_${snapshot.data.docs[0]['shopId']}.png"),
                                    maxRadius: 25,
                                  ),
                                ),
                              ],
                        ...
                        : snapshot.data.docs[0]['status'] == 'Placed' &&
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            S
                                                .of(context)
                                                .after_count_down_end_cant_be_cancelled,
                                            style: Theme.of(context)
                                                .textTheme
                                                .caption,
                                          ),
                            ...
                            : snapshot.data.docs[0]['status'] == 'Accepted'
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                S
                                                    .of(context)
                                                    .your_order_is_being_prepared_now,
                                                style: Theme.of(context)
                                                    .textTheme
                                                    .caption,
                                              ),
                                ...
                                : snapshot.data.docs[0]['status'] == 'Packed'
                                    ? Container(
                                        padding: EdgeInsets.only(
                                            left: 18, right: 18, bottom: 18),
                                        color: Theme.of(context).primaryColor,
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    S
                                                        .of(context)
                                                        .your_order_is_packed_right_now,
                                                    style: Theme.of(context)
                                                        .textTheme
                                                        .caption,
                                                  ),
                                                  ...
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Text(
                                                        S
                                                            .of(context)
                                                            .your_order_is_ready_to_pickup_from_the_store,
                                                        style: Theme.of(context)
                                                            .textTheme
                                                            .caption,
                                                      ),
                                                    ...
                                                    Badge(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: CircleAvatar(
                                                          ...
                                                          backgroundImage:
                                                              NetworkImage(
                                                                  "${GlobalConfiguration().getString('base_upload')}/uploads/driver_image/driver_${snapshot.data.docs[0]['driverId']}.png"),
                                                          maxRadius: 25,
                                                        ),
                                                      ),
                                                    ),
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  Text('Tax',
                                      style:
                                          Theme.of(context).textTheme.caption),
                                  Text(Helper.pricePrint(paymentData.tax),
                                      style:
                                          Theme.of(context).textTheme.caption),
                                ],
                              ),
