...
import 'package:edeli/src/Animation/FadeAnimation.dart';
                          ...
                          Container(
                            ...
                            child: Wrap(
                              children: List.generate(
                                  widget.providerList.length, (index) {
                                ProviderList _provider =
                                    widget.providerList.elementAt(index);
                                return Div(
                                  child: FadeAnimation(
                                    1.4,
                                    Container(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(width: 5.0),
                                                    Text(
                                                      '${_provider.ratingNum}(${_provider.ratingTotal})',
                                                      overflow:
                                                          TextOverflow.ellipsis,
                                                      maxLines: 1,
                                                      textAlign: TextAlign.left,
