...
import 'package:edeli/src/elements/PermissionDeniedWidget.dart';
import 'package:edeli/src/models/address.dart';
import 'package:edeli/src/repository/hservice_repository.dart';
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Center(
                              child: Text(S.of(context).choose_provider,
    ...
    return Container(
      child: Stack(
        children: <Widget>[
          ...
          Image(
            image: NetworkImage(currentBookDetail.value.subcategoryImg),
            height: 300,
            width: double.infinity,
            fit: BoxFit.cover,
          ),
                          ...
                          children: <Widget>[
                            ...
                            currentUser.value.address.isEmpty
                                                                            ...
                                                                            Expanded(
                                                                                child: Container(
                                                                                    ...
                                                                                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                                                      ...
                                                                                      Text(selectedPlace?.formattedAddress, overflow: TextOverflow.ellipsis, maxLines: 2, style: Theme.of(context).textTheme.bodyText2),
                                                                                    ])))
                                                                          ]),
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                              () {
                                                                            _con.addressData.latitude =
                                                                                selectedPlace.geometry.location.lat;
                                                                            _con.addressData.longitude =
                                                                                selectedPlace.geometry.location.lng;
                                                                            _con.addressData.addressSelect =
                                                                                selectedPlace?.formattedAddress;
                                                                            _con.addressData.isDefault =
                                                                                'false';
                                                                          ...
                                                                          child:
                                                                              Center(child: Text(S.of(context).save_and_proceed, style: Theme.of(context).textTheme.subtitle1.merge(TextStyle(color: Theme.of(context).primaryColorLight)))),
                                                                        ),
                                                                      ),
                                                                    ],
                                                                  ),
                                ...
                                : Container(
                                    ...
                                    child: ListView.builder(
                                        itemCount:
                                            currentUser.value.address.length,
                                        scrollDirection: Axis.horizontal,
                                        itemBuilder: (context, int index) {
                                          Address _address = currentUser
                                              .value.address
                                              .elementAt(index);
                                          return Row(
                                            children: <Widget>[
                                                                                    ...
                                                                                    child: Column(
                                                                                      ...
                                                                                      children: [
                                                                                        ...
                                                                                        Row(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                                                          Align(alignment: Alignment.topLeft, child: Icon(Icons.location_on_outlined, size: 30)),
                                                                                          Expanded(
                                                                                              child: Container(
                                                                                                  padding: EdgeInsets.only(left: 10),
                                                                                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                                                        ...
                                                                                        Container(
                                                                                          ...
                                                                                          child: MaterialButton(
                                                                                            ...
                                                                                            child: Center(child: Text(S.of(context).save_and_proceed, style: Theme.of(context).textTheme.subtitle1.merge(TextStyle(color: Theme.of(context).primaryColorLight)))),
                                                                                          ),
                                                                                        ),
                                                                                      ],
                                                                                    ),
                              ...
                              child: SingleChildScrollView(
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      onSaved: (input) => currentBookDetail
