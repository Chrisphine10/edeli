...
import 'package:edeli/src/elements/ButtonShimmerWidget.dart';
import 'package:edeli/src/elements/ControllPanelWidget.dart';
import 'package:edeli/src/elements/FixedBannerWidget.dart';
import 'package:edeli/src/elements/HandyManCard.dart';
import 'package:edeli/src/elements/MyRecommendedTypeWidge.dart';
import 'package:edeli/src/elements/SearchBarWidget.dart';
import 'package:edeli/src/elements/SearchResultsWidget.dart';
import 'package:edeli/src/elements/ServiceNotAvailableWidget.dart';
import 'package:edeli/src/elements/Spotlight.dart';
                        ...
                        delegate: SliverChildListDelegate(<Widget>[
                            ...
                            child: Row(children: [
                              ...
                              InkWell(
                                ...
                                child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color:
                                            Color(0xFFaeaeae).withOpacity(0.1),
                          ...
                          Container(
                            ...
                            child: Row(
                                ...
                                children: [
                                  Text(S.of(context).shop_categories,
                                      style: Theme.of(context)
                                          .textTheme
                                          .headline3),
                                  Container(
                              ...
                              : Container(
                                  ...
                                  child: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        MainCategoryModel _category = _con
                                            .mainShopCategories
                                            .elementAt(index);
                          ...
                          SizedBox(height: 40),
                          currentUser.value.zoneId != "no_matched"
                              ? HandyManCard()
                          ...
                          currentUser.value.zoneId != "no_matched"
                              ? Container(
                                  padding: EdgeInsets.symmetric(horizontal: 20),
                                  child: Text(
                                      S.of(context).best_recommended_shop,
                                      style: Theme.of(context)
                                          .textTheme
                                          .headline3),
                                )
                              : Container(),
                          Container(
                            child: currentUser.value.zoneId != "no_matched"
                                ? SpotlightWidget()
                                : Container(),
                          ),
                          //TopProductWidget(),
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Container(
                            ...
                            child: Text(
                              '${S.of(context).changing_your_location}.',
                              style: Theme.of(context).textTheme.caption,
                            ))
                      ]),
                )),
