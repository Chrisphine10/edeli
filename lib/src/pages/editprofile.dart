...
import 'package:edeli/src/controllers/user_controller.dart';
import 'package:edeli/src/elements/LocationWidget.dart';
import 'package:edeli/src/models/user.dart';
...
class SliverCustomHeaderDelegate extends SliverPersistentHeaderDelegate {
  ...
  Color makeStickyHeaderTextColor(shrinkOffset, isIcon) {
    if (shrinkOffset <= 50) {
      ...
      final int alpha = (shrinkOffset / (this.maxExtent - this.minExtent) * 300)
          .clamp(0, 255)
          .toInt();
    ...
    return Container(
      child: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          CustomDividerView(
              dividerHeight: 1.0, color: Theme.of(context).dividerColor),
          Container(
              ...
              child: TextFormField(
                  ...
                  enabled: currentUser.value.loginVia == 'GMail' ||
                          currentUser.value.loginVia == 'Fb'
                      ? false
                      : true,
          ...
          Container(
            ...
            child: Padding(
              ...
              child: TextFormField(
                ...
                onSaved: (input) =>
                    widget.con.register_data.description = input,
  ...
  void register(File image) async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        // ignore: deprecated_member_use
        currentUser.value.image =
            '${GlobalConfiguration().getString('base_upload')}uploads/user_image/user_${currentUser.value.id}.jpg';
      });
