...
import 'package:edeli/src/components/PaybuttonLoader.dart';
import 'package:edeli/src/pages/payment_page.dart';
            ...
            children: <Widget>[
              ValueListenableBuilder(
                  ...
                  builder: (context, _setting, _) {
                    return _con.checkOutButtonLoad
                        ? PayButtonLoader()
                        : Column(children: [
                            ...
                            currentCheckout.value.deliveryPossible &&
                                    currentCheckout.value.grand_total > 0 &&
                                    currentCheckout.value.sub_total >=
                                        setting.value.minimum_purchase &&
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        Container(
                                                                            ...
                                                                            height:
                                                                                30,
                                                                            child:
                                                                                Image.asset(currentUser.value.paymentImage)),
                                                                        Container(
                                                                            padding:
                                                                                EdgeInsets.only(left: 7, bottom: 8),
                                                                            child: Text(
                                                                              S.of(context).pay_using,
                                                                            )),
                                                                        Icon(Icons
                                                                            .arrow_drop_up)
                                                                      ])),
                                                ...
                                                child: Container(
                                                  ...
                                                  child: ElevatedButton(
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        Text(
                                                          'We are not accepting orders below ${Helper.pricePrint(setting.value.minimum_purchase)}.',
                                                          style: Theme.of(
                                                                  context)
                                                              .textTheme
                                                              .subtitle2
                ...
                builder: (context, _setting, _) {
                  ...
                  return SliverPersistentHeader(
                    ...
                    delegate: SliverCustomHeaderDelegate(
                      ...
                      subtitle:
                          '${currentCart.value.length} ${S.of(context).items}, ${S.of(context).to_pay}  ${Helper.pricePrint(currentCheckout.value.grand_total)}',
                    ),
                  );
                }),
            SliverList(
