  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      /* floatingActionButton: Builder(
          ...
          providerId: currentBookView.value.providerid,
          providerName: currentBookView.value.providename,
          providerMobile: currentBookView.value.providermobile)));
          },
          elevation: 2.0,
          fillColor: Colors.green,
          child: Icon(
            ...
            child: Column(children: [
              ...
              StreamBuilder(
                  stream: FirebaseFirestore.instance
                      .collection("HService")
                      .where("bookId", isEqualTo: currentBookView.value.bookId)
                      .snapshots(),
                                ...
                                children: <Widget>[
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        Helper.pricePrint(snapshot.data.docs[0]
                                            ['chargeperhrs']),
                                        textAlign: TextAlign.center,
                                        style: Theme.of(context)
                                            .textTheme
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.hasError || snapshot.data == null) {
                        ...
                        bool startedCustomerPlaced =
                            snapshot.data.docs[0]['startedCustomerPlaced'];
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(children: [
                                  ...
                                  children: [
                                    Text(S.of(context).provider_name,
                                        style: Theme.of(context)
                                            .textTheme
                                            .subtitle2),
                                    Text(snapshot.data.docs[0]['providerName'],
                                        style: Theme.of(context)
                                            .textTheme
                                            .subtitle2)
                                  ],
                                ...
                                SizedBox(height: 12),
                                snapshot.data.docs[0]['miscellaneousAmount'] !=
                                        0
                                    ? Row(
                                        mainAxisAlignment:
                                            MainAxisAlignment.spaceBetween,
                              ...
                              child: Column(children: [
                                ...
                                Row(
                                  mainAxisAlignment:
                                      MainAxisAlignment.spaceBetween,
                                  children: [
                                    Text('GST ${snapshot.data.docs[0]['tax']}%',
                                        style: Theme.of(context)
                                            .textTheme
                                            .subtitle2),
                                    Text(
                                        Helper.pricePrint(
                                            snapshot.data.docs[0]['taxAmount']),
                                        style: Theme.of(context)
                                            .textTheme
                                            .subtitle2),
                                  ],
                        ...
                        child: Column(children: [
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                  Helper.pricePrint(
                                      snapshot.data.docs[0]['grandTotal']),
                                  style: TextStyle(
                                    fontSize: 18,
                                  ))
                            ],
