  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0.5,
          title: Text(
            '${S.of(context).bill_total}  ${Helper.pricePrint(currentCheckout.value.grand_total)}',
                            ...
                            children: <Widget>[
                              ...
                              setting.value.flutterWave
                                  ? Container(
                                      child: InkWell(
                                        onTap: () {
                                          setSelectedRadio(2, 'flutterwave',
                              ...
                              setting.value.mpesa
                                  ? Container(
                                      child: InkWell(
                                        onTap: () {
                                          setSelectedRadio(2, 'mpesa',
                                              'assets/img/M-pesa-logo.png');
                                        },
                                        child: Container(
                                            padding: EdgeInsets.only(
                                                top: 15,
                                  ...
                                  onTap: () {
                                    if (currentUser.value.walletAmount != '0') {
                                      if (int.parse(
                                        ...
                                        setSelectedRadio(1, 'wallet',
                                            'assets/img/wallet.png');
                                      } else {
                                        _con.showToast(
                                            S
                                                .of(context)
                                                .low_balance_please_recharge,
                                      ...
                                      _con.showToast(
                                          S
                                              .of(context)
                                              .your_wallet_balance_is_0_please_recharge,
                                          gravity: Toast.BOTTOM,
                                          duration: Toast.LENGTH_SHORT);
                                    }
                                  },
