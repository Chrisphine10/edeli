...
class TakeawayWidget extends StatefulWidget {
  ...
  TakeawayWidget({Key key, this.parentScaffoldKey, this.orderId})
      : super(key: key);
                                  ...
                                  child: Row(children: [
                                    ...
                                    TimelineTile(
                                        ...
                                        endChild: Container(
                                          width: 80,
                                          child: Text(
                                              S.of(context).ready_for_handover,
                                              textAlign: TextAlign.center,
                                              style: Theme.of(context)
                                                  .textTheme
                                                  .caption),
                                  ...
                                  Container(
                                    ...
                                    child: Row(children: [
                                      ...
                                      InkWell(
                                        onTap: () {
                                          _con.openMap(
                                              _con.takeawayData.shopLatitude,
                                              _con.takeawayData.shopLongitude);
                                        },
