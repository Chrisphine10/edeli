...
import 'package:edeli/src/elements/RectangularLoaderWidget.dart';
import 'package:edeli/src/elements/SearchWidgetRe.dart';
...
class _StoreViewDetailsState extends StateMVC<StoreViewDetails>
  ...
  loaderMenuSwap() {
    _tabController = new TabController(
        vsync: this, length: _con.vendorResProductList.length);
  }
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FancyFab(
            product: _con.vendorResProductList, moveSwap: this.moveSwap),
...
class FancyFab extends StatefulWidget {
  ...
  FancyFab(
      {this.onPressed, this.tooltip, this.icon, this.product, this.moveSwap});
                          ...
                          itemBuilder: (context, int index) {
                            ...
                            return InkWell(
                              ...
                              child: ListTile(
                                ...
                                trailing: Container(
                                    child: Text(
                                  _product.productdetails.length.toString(),
                                  style: Theme.of(context).textTheme.headline1,
                                )),
                              ),
                            );
