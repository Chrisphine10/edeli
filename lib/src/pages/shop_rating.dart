...
import 'package:edeli/src/models/order_details.dart';
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    Text(
                                        S
                                            .of(context)
                                            .what_did_the_restaurant_impress_you_with,
                                      ...
                                      child: Column(children: [
                                        Container(
                                            ...
                                            decoration: BoxDecoration(
                                                ...
                                                color: _con.shopRatingData.taste
                                                    ? Colors.green
                                                    : Colors.black
                                                        .withOpacity(0.1)),
                                            child: Image(
                                      ...
                                      child: Column(children: [
                                        Container(
                                            ...
                                            decoration: BoxDecoration(
                                                shape: BoxShape.circle,
                                                color:
                                                    _con.shopRatingData.portion
                                                        ? Colors.green
                                                        : Colors.black
                                                            .withOpacity(0.1)),
                                            child: Image(
                                                image: AssetImage(
                                                    'assets/img/portion.png'))),
                                        SizedBox(height: 10),
                                        Text(S.of(context).portion,
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodyText1)
                                      ]),
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          S
                                              .of(context)
                                              .your_word_make_grocery_a_better_place_you_are_the_influence,
                                          style: Theme.of(context)
                                              .textTheme
                                              .caption)
                                    ])),
                ...
                child: Padding(
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                        onPressed: () {
                          _con.shopRatingData.vendor =
                              widget.invoiceDetailsData.addressShop.id;
                          _con.submitShopRating(
                              widget.invoiceDetailsData.saleCode);
                        },
                        child: Text(
