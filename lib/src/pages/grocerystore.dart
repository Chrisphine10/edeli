...
import 'package:edeli/src/elements/BottomBarWidget.dart';
import 'package:edeli/src/elements/DeliveryModeWidget.dart';
import 'package:edeli/src/elements/MiddleSliderWidget.dart';
import 'package:edeli/src/elements/PrescriptionCardWidget.dart';
import 'package:edeli/src/elements/SearchShopWidget.dart';
import 'package:edeli/src/elements/StoreTimingWidget.dart';
import 'package:edeli/src/elements/VendorDetailsPopup.dart';
import 'package:edeli/src/pages/rating_review.dart';
import 'package:edeli/src/repository/order_repository.dart';
import 'package:edeli/src/repository/user_repository.dart';
import 'package:edeli/src/repository/vendor_repository.dart';
...
class GroceryStoreWidget extends StatefulWidget {
  ...
  int shopTypeID;
  int focusId;
  GroceryStoreWidget({Key key, this.shopDetails, this.shopTypeID, this.focusId})
      : super(key: key);
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                _con.todayDeals != 'No_data'
                    ...
                    : Container(),
                SizedBox(height: 3),
                _con.middleSidleLock != 'No_data'
                    ? MiddleSliderWidget(
                        slides: _con.middleSlides,
                        pageType: 'vendor',
                        para1: widget.shopDetails.shopName,
                        shopId: widget.shopDetails.shopId)
                    : Container(),
                SizedBox(height: 3),
                Container(
                                    ...
                                    children: [
                                      Row(children: [
                                        ...
                                        Column(
                                            ...
                                            children: [
                                              Text(
                                                  '${Helper.calculateTime(double.parse(shopDetails.distance.replaceAll(',', '')), int.parse(shopDetails.handoverTime), false)}',
                                                  style:
                  ...
                  ? Shimmer(
                      ...
                      child: Stack(children: [
                        Container(
                            ...
                            child: Image(
                                image:
                                    AssetImage('assets/img/sellerlable.png'))),
                        Align(
                          alignment: Alignment.center,
                          child: Container(
