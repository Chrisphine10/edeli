...
import 'package:edeli/src/elements/ClearCartWidget.dart';
import 'package:edeli/src/models/vendor.dart';
...
class UploadPrescription extends StatefulWidget {
  ...
  int shopTypeID;
  int focusId;
  UploadPrescription({Key key, this.shopDetails, this.shopTypeID, this.focusId})
      : super(key: key);
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(S.of(context).upload_prescription,
                ...
                Expanded(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        Text(S.of(context).have_a_prescription_upload_here,
                            style: Theme.of(context).textTheme.headline1),
                        InkWell(
                            onTap: () {},
                            child: Container(
                              ...
                              child: Wrap(
                                children: [
                                  ...
                                  Div(
                                    child: GestureDetector(
                                      onTap: () {
                                        PrescriptionGuidePopupHelper.exit(
                                            context);
                                      },
                                      child: Container(
                                        child: Column(
                        ...
                        Container(
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              child: Container(
                                  child: Text(
                                      S.of(context).valid_prescription_guide,
                                      style: Theme.of(context)
                                          .textTheme
                                          .subtitle2
                        ...
                        Container(
                          ...
                          children: [
                            Container(
                                child: Text(
                                    S.of(context).why_upload_a_prescription,
                                    style: Theme.of(context)
                                        .textTheme
                                        .subtitle2
                                        .merge(TextStyle(color: redColor)))),
...
class PrescriptionGuidePopupHelper {
  static exit(context) => showDialog(
      context: context, builder: (context) => PrescriptionGuidePopup());
}
            ...
            children: <Widget>[
              Padding(
                ...
                child: Row(
                    ...
                    children: [
                      Text(S.of(context).valid_prescription_guide,
                          style: Theme.of(context).textTheme.headline1),
                      IconButton(
                        onPressed: () {
                          Navigator.pop(context);
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                            S
                                .of(context)
                                .include_detail_of_doctor_and_patient_clinic_visit_details,
                      ...
                      Padding(
                        ...
                        child: Text(
                            S
                                .of(context)
                                .medicines_will_be_dispensed_as_per_prescription,
                            style: Theme.of(context).textTheme.subtitle2),
                      ),
                      SizedBox(height: 30),
                    ]),
