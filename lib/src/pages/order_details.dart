...
import 'package:edeli/src/controllers/order_controller.dart';
import 'package:edeli/src/elements/DriverRatingWidget.dart';
import 'package:edeli/src/elements/EmptyOrdersWidget.dart';
import 'package:edeli/src/helpers/helper.dart';
import 'package:edeli/src/models/addon.dart';
import 'package:edeli/src/models/cart_responce.dart';
import 'package:edeli/src/pages/takeaway_map.dart';
                  ...
                  children: <Widget>[
                                                        ...
                                                        children: [
                                                          Padding(
                                                            ...
                                                            child: CircleAvatar(
                                                              ...
                                                              backgroundImage:
                                                                  NetworkImage(
                                                                      "${GlobalConfiguration().getString('base_upload')}/uploads/vendor_image/vendor_${_con.invoiceDetailsData.addressShop.id}.png"),
                                                              maxRadius: 23,
                                                            ),
                                                          ),
                                                          SizedBox(width: 10),
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Text(
                                                      _con.invoiceDetailsData
                                                          ...
                                                          ? S
                                                              .of(context)
                                                              .your_order_type_is_instant_delivery
                                                          : _con.invoiceDetailsData
                                                                      .orderType ==
                                                                  '2'
                                                              ? 'Your Order type is Scheduled Delivery (${_con.invoiceDetailsData.deliverySlot})'
                                                              : 'Your Order type is Takeaway',
                                                      style: Theme.of(context)
                                                          .textTheme
                                                          .bodyText2,
                                                      textAlign: TextAlign.left,
                                                                    ...
                                                                    children: List.generate(
                                                                      ...
                                                                      AddonModel
                                                                          ...
                                                                          _orderDetails
                                                                              ...
                                                                              .elementAt(index);
                                                                      return Container(
                                                                          child: _orderDetails.addon.length != 0
                                                                              ? Text(
                                                                                  '${_adddon.name}  ${Helper.pricePrint(_adddon.price)}',
                                                ...
                                                children: [
                                                  ...
                                                  _con.invoiceDetailsData
                                                      ...
                                                      ? Row(
                                                          ...
                                                          children: [
                                                            ...
                                                            SizedBox(width: 10),
                                                            Text(
                                                              '-${Helper.pricePrint(_con.invoiceDetailsData.payment.discount)}',
                                                              style: Theme.of(
                                                                      context)
                                                                  .textTheme
                                                                  .caption
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      SizedBox(width: 10),
                                                      Text(
                                                        '${S.of(context).bill_total} ${Helper.pricePrint(_con.invoiceDetailsData.payment.grand_total)}',
                                                        style: Theme.of(context)
                                                            .textTheme
                                                            .subtitle2
                                                            .merge(TextStyle(
                                                              ...
                                                              ListTile(
                                                                ...
                                                                title:
                                                                  ...
                                                                  child: Column(
                                                                      ...
                                                                      children: [
                                                                        Text(
                                                                          'im ${_con.invoiceDetailsData.driverName}, your delivery partner',
                                                                          style: Theme.of(context)
                                                                              .textTheme
                                                                              .subtitle1,
                                                                        ),
                    ...
                    Align(
                      ...
                      child: Padding(
                          ...
                          child: _con.invoiceDetailsData.status != 'Delivered'
                              ? Container(
                                  width: double.infinity,
                                  decoration: BoxDecoration(
                                      border: Border(
                                  ...
                                  ? Container(
                                      ...
                                      child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text(_con.invoiceDetailsData.status,
                                                style: Theme.of(context)
                                                    .textTheme
                                                    .headline3)
                                          ]))
