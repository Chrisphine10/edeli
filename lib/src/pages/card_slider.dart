...
class CardSliderListItemView {
  const CardSliderListItemView(
      {this.title, this.icon, this.subtitle, this.review, this.price});
  final String title;
  final String icon;
...
const List<CardSliderListItemView> choices = const <CardSliderListItemView>[
  ...
  const CardSliderListItemView(
    ...
    subtitle:
        'South Indian, Chinese, Biryani, Saradha college road, Saradha college road',
    review: '(100 Reviews)',
    price: '\$ 200',
  ),
  const CardSliderListItemView(
    ...
    subtitle:
        'Arabian, Tandoor, Chinese, Junction Main Road, Saradha college road',
    review: '(105 Reviews)',
    price: '\$ 170',
  ),
  const CardSliderListItemView(
    ...
    subtitle:
        'North Indian, South Indian, Biryani, VIVEKANANDAR NAGAR TRICHY MAINROAD, Seelanaickenpatti',
    review: '(190 Reviews)',
    price: '\$ 200',
  ),
];
