...
import 'package:edeli/src/controllers/flutterwave_controller.dart';
...
class FlutterWavePaymentWidget extends StatefulWidget {
  ...
  @override
  _FlutterWavePaymentWidgetState createState() =>
      _FlutterWavePaymentWidgetState();
}
        ...
        children: <Widget>[
          WebView(
              ...
              onPageStarted: (String url) {
                ...
                if (url ==
                    "${GlobalConfiguration().getString('api_base_url')}Flutterwave/success") {
