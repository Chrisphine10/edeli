                                ...
                                ListView(
                                  ...
                                  children: <Widget>[
                                    ...
                                    InkWell(
                                      onTap: () async {
                                        var whatsapp =
                                            setting.value.customerSupport;
                                        var whatsappURlAndroid =
                                            "whatsapp://send?phone=" +
                                                whatsapp +
                                                "&text=Hi ${setting.value.appName}";
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Text(S.of(context).return_policy,
                                                style: Theme.of(context)
                                                    .textTheme
                                                    .subtitle2),
                                          ],
